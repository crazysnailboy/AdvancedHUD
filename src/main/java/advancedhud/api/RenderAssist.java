...
//    }
    ...
    public static void drawTexturedModalRect(int x, int y, int textureX, int textureY, int width, int height) {
        ...
        worldRenderer.addVertexWithUV(x + 0, y + height, RenderAssist.zLevel, (textureX + 0) * f, (textureY + height) * f);
        worldRenderer.addVertexWithUV(x + width, y + height, RenderAssist.zLevel, (textureX + width) * f, (textureY + height) * f);
        worldRenderer.addVertexWithUV(x + width, y + 0, RenderAssist.zLevel, (textureX + width) * f, (textureY + 0) * f);
        worldRenderer.addVertexWithUV(x + 0, y + 0, RenderAssist.zLevel, (textureX + 0) * f, (textureY + 0) * f);
        tessellator.draw();
    }
...
//    }
    ...
    private static void drawSpriteUV(int x, int y, int width, int height, float u1, float v1, float u2, float v2) {
        ...
        WorldRenderer worldRenderer = tessellator.getWorldRenderer();
        worldRenderer.startDrawingQuads();
        worldRenderer.addVertexWithUV(x, y + height, zLevel, u1, v2);
        worldRenderer.addVertexWithUV(x + width, y + height, zLevel, u2, v2);
        worldRenderer.addVertexWithUV(x + width, y, zLevel, u2, v1);
        worldRenderer.addVertexWithUV(x, y, zLevel, u1, v1);
        tessellator.draw();
    }
