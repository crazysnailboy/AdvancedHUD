...
public class GuiScreenReposition extends GuiScreen {
    ...
    private void drawHoveringText(int mouseX, int mouseY) {
        ...
        tooltip.add(TextFormatting.YELLOW + this.hudItem.getDisplayName());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (help) {
            this.drawCenteredString(this.mc.fontRenderer, I18n.format("advancedhud.reposition.controls"), this.width / 2, 40, 0xFFFFFF);
        }
